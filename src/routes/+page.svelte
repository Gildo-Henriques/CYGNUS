<script>
  ...
  import ExecutiveTeam from "$lib/ExecutiveTeam.svelte";
  import FaQ from "$lib/FaQ.svelte";
  import Planeta from "$lib/Planeta.svelte";
  import Price from "$lib/Price.svelte";
  import Seo from "$lib/Seo.svelte";
  import Servicos from "$lib/Servicos.svelte";
  import Sobre from "$lib/Sobre.svelte";
  import Testemunhas from "$lib/Testemunhas.svelte";
</script>

<body class="bg-gray-950 relative">
  <section class="mt-20 flex justify-center items-center w-full">
    <div class="lg:w-3/4 w-full gap-y-8 flex flex-col px-5 items-center justify-center">
      <div class="gradient-x-5 gradient-border px-5 py-1 rounded-full">
        <span class="text-white">Seja bem-vindo no nosso site</span>
      </div>
      <h1
        class="text-center font-bold lg:text-6xl text-4xl text-transparent bg-gradient-radial bg-clip-text"
      >
        Levando Sua Presença Digital a Todos os Cantos do Mundo
      </h1>
      <div class="lg:px-20 flex flex-col justify-center items-center gap-y-5">
        <p class="text-white text-center text-lg">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam tenetur
          animi modi dignissimos aliquam molestias, quam omnis earum a eaque
          nemo, dolor quia repellat! Dignissimos velit labore nostrum
          perspiciatis commodi!
        </p>
        <div class="flex lg:flex-row flex-col text-white *:text-center *:lg:w-auto *:w-full *:rounded-lg gap-5">
          <a
            href=""
            class="relative gradient-border-btn p-2 text-white bg-gray-950 px-5 rounded-md transition-all duration-1000"
          >
            Inicie a sua expansão
          </a>

          <a
            href=""
            class="space-x-2 flex items-center border border-raven-200 hover:border-raven-400 text-white px-5 py-3"
          >
            <span>Explore nossos projectos</span>
            <span class="h-full items-center"
              ><svg
  ...
  <section class="flex 2xl:px-20 lg:px-16 px-2 justify-center">
    <div
      class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 *:space-y-5 *:bg-gradient-to-t *:to-gray-900  *:from-gray-950 *:2xl:p-8 *:lg:p-5 *:p-5 *:rounded-lg gap-8"
    >
      <article class="text-gray-400 text-sm" data-aos="fade-up"
      data-aos-anchor-placement="center-center" data-aos-duration="1000">
        <div class="flex items-center space-x-3 text-gray-300 text-lg">
          <span
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
          ...
          >
          <h2>Posicionamento no google</h2>
        </div>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati
          dolore, voluptates corporis accusantium animi ratione! Iusto et
          necessitatibus quam autem quasi rerum sunt corrupti eius assumenda?
          Fugit adipisci facere recusandae.
        </p>
      </article>
      <article class="text-gray-400 text-sm" data-aos="fade-up"
      data-aos-anchor-placement="center-center" data-aos-duration="1000">
        <div class="flex items-center space-x-3 text-gray-300 text-lg">
          ...
          <h2>SEO e Analytics para alcançar seu público</h2>
        </div>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati
          dolore, voluptates corporis accusantium animi ratione! Iusto et
      ...
      data-aos-anchor-placement="center-center" data-aos-duration="1000">
        <div class="flex items-center space-x-3 text-gray-300 text-lg">
          ...
          <h2>Sites que atraem e convertem clientes</h2>
        </div>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati
          dolore, voluptates corporis accusantium animi ratione! Iusto et
      ...
      data-aos-anchor-placement="center-center" data-aos-duration="1200">
        <div class="flex items-center space-x-3 text-gray-300 text-lg">
          ...
          <h2>Otimização Focada no público certo</h2>
        </div>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati
          dolore, voluptates corporis accusantium animi ratione! Iusto et
  ...
  <Servicos />
  <Seo />
  <section class="w-full  bg-slate-900  lg:px-20 px-5 py-10 space-y-20 overflow-hidden">
    <div class="space-y-5" 
    >
      <div class="flex flex-col space-y-5" data-aos="fade-up"
      data-aos-anchor-placement="center-center" data-aos-duration="1000">
        <span class="text-gray-600 font-semibold">NOSSAS SOLUÇÕES</span>
      <h2
        class="text-5xl font-bold text-transparent bg-gradient-radial bg-clip-text"
      >
        Criar um site de alto <br />desempenho
      </h2>
      <div class="lg:w-[500px] w-full">
        <p class="text-gray-500">
          Lorem ipsum dolor, sit amet consectetur adipisicing elit. A libero
          necessitatibus vitae, sunt atque dolore repudiandae quia, alias veniam
          doloribus laborum sapiente perferendis! Voluptatibus tempore porro,
          laborum ducimus quidem ex.
        </p>
      </div>
      </div>
      
      <div class="grid gap-5 lg:grid-cols-2 *:lg:h-52 *:h-auto grid-cols-1">
        <article class="w-full space-x-5 border border-gray-600 rounded-xl  flex lg:p-8 p-5" data-aos="fade-up"
      data-aos-anchor-placement="center-center" data-aos-duration="1000">
          <div class="border p-4 border-purple-800 bg-purple-700/15 flex justify-center items-center rounded-lg lg:w-20 h-14">
            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" class="size-6" fill="#6b21a8"><path d="m23.952,8.462l-1.414-1.414-2.524,2.524-5.586-5.586,2.524-2.524L15.538.048l-3.076,3.076-8.283,3.074L.01,23.99l17.792-4.169,3.074-8.283,3.076-3.076Zm-7.652,9.657l-11.761,2.756,4.943-4.943c.165.044.339.068.518.068,1.105,0,2-.895,2-2s-.895-2-2-2-2,.895-2,2c0,.179.024.353.068.518l-4.943,4.943,2.756-11.761,6.879-2.553,6.093,6.093-2.553,6.879Z"/></svg>
          </div>
          <div class="flex flex-col space-y-3">
            <h2 class="text-white font-semibold text-2xl">Design de UX / UI</h2>
            <p class="text-gray-400 text-lg">Vivamus eu est eget ipsum molestie commodo in idtam scelerisque vehicula felis, vitae volutpat diam efficir id.</p>
          </div>
        </article>
        <article class="w-full space-x-5 border border-gray-600 rounded-xl  flex lg:p-8 p-5" data-aos="fade-up"
      data-aos-anchor-placement="center-center" data-aos-duration="1000">
          <div class="border border-green-800 p-4 bg-green-700/15 flex justify-center items-center rounded-lg w-20 h-14">
          ...
          <div class="flex flex-col space-y-3">
            <h2 class="text-white font-semibold text-2xl">Desenvolvimento da Web</h2>
            <p class="text-gray-400 text-lg">Vivamus eu est eget ipsum molestie commodo in idtam scelerisque vehicula felis, vitae volutpat diam efficir id.</p>
          </div>
        </article>
        <article class="w-full space-x-5 border border-gray-600 rounded-xl  flex lg:p-8 p-5" data-aos="fade-up"
      data-aos-anchor-placement="center-center" data-aos-duration="1000">
          <div class="border p-4 border-yellow-600 bg-yellow-600/15 flex justify-center items-center rounded-lg w-20 h-14">
          ...
          <div class="flex flex-col space-y-3">
            <h2 class="text-white font-semibold text-2xl">Desenvolvimento de Aplicativos Móveis</h2>
            <p class="text-gray-400 text-lg">Vivamus eu est eget ipsum molestie commodo in idtam scelerisque vehicula felis, vitae volutpat diam efficir id.</p>
          </div>
        </article>
        <article class="w-full space-x-5 border border-gray-600 rounded-xl  flex lg:p-8 p-5" data-aos="fade-up"
      data-aos-anchor-placement="center-center" data-aos-duration="1000"> 
          <div class="border border-cyan-600 p-4 bg-cyan-400/15 flex justify-center items-center rounded-lg w-20 h-14">
          ...
          <div class="flex flex-col space-y-3">
            <h2 class="text-white font-semibold text-2xl">Garantia de qualidade</h2>
            <p class="text-gray-400 text-lg">Vivamus eu est eget ipsum molestie commodo in idtam scelerisque vehicula felis, vitae volutpat diam efficir id.</p>
          </div>
        </article>
      </div>
    </div>
    <div class="text-center flex justify-center items-center flex-col text-white space-y-5 px-5" data-aos="fade-up"
    data-aos-anchor-placement="center-center" data-aos-duration="1000">
      <span>PILHA DE TECNOLOGÍA MODERNA</span>
      <h2 class="font-semibold text-3xl">Construindo a web</h2>
      <div class="space-y-10 w;full flex flex-col items-center">
        <div class="lg:w-[700px] text-center text-white">
          <p>
            Trabalhamos com tecnologias de ponta projetadas para resolver as necessidades do seu produto. Concentre-se em encontrar soluções para as necessidades do seu negócio enquanto lidamos com o aspecto técnico. 
          </p>
        </div>
        <div class="grid lg:grid-cols-4 grid-cols-2 lg:justify-items-center gap-8 *:flex *:items-center">
          ...
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 32 32" fill="none">
              ...
              <span class="text-gray-500 text-lg">JavaScript</span>
          </article>
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40px" height="40px" viewBox="-4 0 264 264" version="1.1" preserveAspectRatio="xMidYMid">
              <g>
          ...
          <span class="text-gray-500 text-lg">Laravel</span>
          </article>
          <article>
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:serif="http://www.serif.com/" width="50px" height="50px" viewBox="0 0 64 64" version="1.1" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
          ...
          <span class="text-gray-500 text-lg">Flutter</span>
          </article>
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40px" height="40px" viewBox="0 0 256 256" version="1.1" preserveAspectRatio="xMidYMid">
              <g>
                ...
                <path d="M181.338,36.298 L151.684,6.862 C144.826,0.068 135.494,-2.046 130.984,2.178 L53.988,53.142 L173.212,53.126 L179.12,53.33 C181.794,53.414 184.744,53.9 187.82,54.686 L181.338,36.298 L181.338,36.298 Z" fill="#00D2B8">
            
            </path>
              </g>
            </svg>
            <span class="text-gray-500 text-lg">Dart</span>
          </article>
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" height="40" viewBox="0 0 24 24" width="40"><g fill="none" fill-rule="evenodd" transform="translate(4)"><circle cx="12" cy="12" fill="#19bcfe" r="4"/><path d="m4 24c2.209139 0 4-1.790861 4-4 0-.6030539 0-1.9363872 0-4-1.79696123 0-3.13029457 0-4 0-2.209139 0-4 1.790861-4 4s1.790861 4 4 4z" fill="#09cf83"/><path d="m4 16h4v-8c-1.930287 0-3.26362033 0-4 0-2.209139 0-4 1.790861-4 4s1.790861 4 4 4z" fill="#a259ff"/><path d="m4 8h4v-8c-1.930287 0-3.26362033 0-4 0-2.209139 0-4 1.790861-4 4s1.790861 4 4 4z" fill="#f24e1e"/><path d="m12 8h-4v-8h4c2.209139 0 4 1.790861 4 4s-1.790861 4-4 4z" fill="#ff7262"/></g></svg>
            <span class="text-gray-500 text-lg">Figma</span>
          </article>
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 32 32" fill="none">
              ...
              <span class="text-gray-500 text-lg">PHP</span>
          </article>
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40px" height="40px" viewBox="-52.5 0 361 361" version="1.1" preserveAspectRatio="xMidYMid">
              <g>
          ...
          <span class="text-gray-500 text-lg">HTML</span>
          </article>
          <article class="space-x-2">
          ...
          <span class="text-gray-500 text-lg">CSS</span>
          </article>
          <article class="space-x-2">
           ...
           <span class="text-gray-500 text-lg">M-DB</span>
          </article>
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="35px" height="35px" viewBox="0 0 32 32"><title>file_type_db</title><path d="M8.562,15.256A21.159,21.159,0,0,0,16,16.449a21.159,21.159,0,0,0,7.438-1.194c1.864-.727,2.525-1.535,2.525-2V9.7a10.357,10.357,0,0,1-2.084,1.076A22.293,22.293,0,0,1,16,12.078a22.36,22.36,0,0,1-7.879-1.3A10.28,10.28,0,0,1,6.037,9.7v3.55C6.037,13.724,6.7,14.528,8.562,15.256Z" style="fill:#c4c7ce"/><path d="M8.562,21.961a15.611,15.611,0,0,0,2.6.741A24.9,24.9,0,0,0,16,23.155a24.9,24.9,0,0,0,4.838-.452,15.614,15.614,0,0,0,2.6-.741c1.864-.727,2.525-1.535,2.525-2v-3.39a10.706,10.706,0,0,1-1.692.825A23.49,23.49,0,0,1,16,18.74a23.49,23.49,0,0,1-8.271-1.348,10.829,10.829,0,0,1-1.692-.825V19.96C6.037,20.426,6.7,21.231,8.562,21.961Z" style="fill:#c4c7ce"/><path d="M16,30c5.5,0,9.963-1.744,9.963-3.894V23.269a10.5,10.5,0,0,1-1.535.762l-.157.063A23.487,23.487,0,0,1,16,25.445a23.422,23.422,0,0,1-8.271-1.351c-.054-.02-.106-.043-.157-.063a10.5,10.5,0,0,1-1.535-.762v2.837C6.037,28.256,10.5,30,16,30Z" style="fill:#c4c7ce"/><ellipse cx="16" cy="5.894" rx="9.963" ry="3.894" style="fill:#c4c7ce"/></svg>
              <span class="text-gray-500 text-lg">SqL</span>
          </article>
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="40px" height="40px" viewBox="0 0 32 32"><title>file_type_tailwind</title><path d="M9,13.7q1.4-5.6,7-5.6c5.6,0,6.3,4.2,9.1,4.9q2.8.7,4.9-2.1-1.4,5.6-7,5.6c-5.6,0-6.3-4.2-9.1-4.9Q11.1,10.9,9,13.7ZM2,22.1q1.4-5.6,7-5.6c5.6,0,6.3,4.2,9.1,4.9q2.8.7,4.9-2.1-1.4,5.6-7,5.6c-5.6,0-6.3-4.2-9.1-4.9Q4.1,19.3,2,22.1Z" style="fill:#44a8b3"/></svg>
            <span class="text-gray-500 text-lg">TailwindCSS</span>
          </article>
          <article class="space-x-2">
            <svg width="35px" height="35px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span class="text-gray-500 text-lg">NodeJS</span>
          </article>
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="35px" height="35px" viewBox="0 -0.5 48 48" version="1.1">
          ...
          <span class="text-gray-500 text-lg">Github</span>
          </article>
          <article class="space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="35px" height="35px" viewBox="0 0 32 32" fill="none">
              ...
              <span class="text-gray-500 text-lg">Adobe</span>
          </article>
        </div>
      </div>
    </div>
