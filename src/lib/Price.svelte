    ...
    <div class="container px-6 py-8 mx-auto">
        <div class="xl:items-center xl:-mx-8 xl:flex">
            ...
            <div class="flex-1 xl:mx-8">
                <div class="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 *:bg-gradient-to-t *:to-gray-900  *:from-gray-950 xl:mt-0">
                    <div class="max-w-sm mx-auto shadow shadow-gray-950 rounded-lg md:mx-4 dark:border-gray-700">
                        <div class="p-6">
